####################################################################
#
# Makefile for CMPT 125 Summer 2021, SFU Surrey.
#
#####################################################################
...
all: clean final_project


final_project: final_project.cpp course.cpp
	g++ $(CPPFLAGS) final_project.cpp course.cpp -o final_project
